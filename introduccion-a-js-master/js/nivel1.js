...
// console.log("el nombre de la variable es " + nombreDeVariable);
...
//     return 'Tu edad es ' + (anioNacimiento - anioActual);
// }

// let edadNacimiento = prompt('Cuál es tu año de nacimiento? ');

// let edadCercana = prompt('Cuál es el año actual? ');

// console.log(edadUsuario(edadNacimiento , edadCercana));


//Esta mal por el single responsability principle el de arriba
