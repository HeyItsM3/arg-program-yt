...
// let comidasFavoritas = ['milanesa', 'bomba de papa', 'pizza'];
...
// const animales = ['gato', 'perro', 'lobo'];
// animales[2] = 'pez';
// animales.push('lobo');
...
//       diez a uno. Los contadores pueden ser para arriba o abajo. ++ o --
...
// const comidasFavoritas = ['milanesa', 'bomba de papa', 'pizza'];

// for(let i = 0; i < comidasFavoritas.length; i++){
//     console.log('Me gustan la ' + comidasFavoritas[i]); //animales[i] se lee "animales en i"
// }
